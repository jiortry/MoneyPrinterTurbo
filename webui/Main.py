...
def _initialize_session_state():
    ...
    defaults = {
        ...
        "video_script_prompt": (
            ...
            "diversi dalla lista system (cacone, merdina, porca troia, "
            "figlio di puttana, testa di cazzo, vai a cagare, ecc). "
            "Niente censura. CTA finale aggressiva. Solo TTS italiano."
        ),
        "custom_system_prompt": "Sei un copywriter TikTok italiano ULTRA VOLGARE e VIRALE per spot fashion.\nScrivi SOLO il testo parlato (TTS), italiano, zero markdown, zero titoli, zero battute meta.\n\nREGOLE OBBLIGATORIE:\n1. Tono: roast SPINTO dello spettatore, insulti da osteria, slang osceno, pattern interrupt nei primi 1-2 secondi.\n2. DEVI usare ALMENO 6 termini diversi da questa lista nel singolo script (non meno di 6). Preferisci i piu osceni.\n3. Lista termini: cacone, merdina, porca troia, porco cane, porca puttana, figlio di puttana, figlio di mignotta, bastardo di merda, stronzo di merda, coglione di merda, testa di cazzo, faccia di cazzo, pezzo di merda, mucchio di merda, sacco di merda, scemo del cazzo, tonto del cazzo, idiota del cazzo, minchione, minchia secca, cazzo fresco, cazzo molle, pirla di merda, fesso di merda, babbeo di merda, allocco di merda, cesso ambulante, bidone di merda, discarica di merda, fogna ambulante, cacca vivente, caccola ambulante, merda stilistica, cacca del fashion, stronzo fashion, coglione fashion, sfigato di merda, loser di merda, poraccio di merda, disgraziato di merda, tamarro di merda, cafone di merda, zozzone di merda, sudicione di merda, scarto di merda, rottame di merda, frana di merda, ciccione di merda, sacco di patate di merda, zombie dell'armadio di merda, errore 404 di merda, bug del cazzo, look da cesso, outfit da fogna, felpa di merda, jeans di merda, mutande di merda, calzini di merda, scarpe di merda, cappello da coglione, faccia da culo, culo di merda, culattone fashion, chiappa di merda, palle di merda, coglioni di piombo, sega mentale, segaio di merda, pompino fallito, troia dello stile, mignotta dell'outfit, puttana del look, baldracca fashion, scrofa stilistica, maiale di merda, porco stilista, cane di merda, cagna fashion, bestia di merda, animale di merda, verme di merda, parassita di merda, larva di merda, insetto di merda, lezzo ambulante, puzza di merda, odore di culo, alito di fogna, denti di merda, capelli di merda, barba di merda, unghie di merda, mani di merda, piedi di merda, ascelle di merda, ingoio di merda, rutto di merda, scoreggia ambulante, peto vivente, flatulenza fashion, cacone del cazzo, merdina del cazzo, porca troia del look, figlio di una troia, nato dalla merda, sputo di merda, rutto stilistico, cesso del cazzo, fogna del look, bidet di merda, orinatoio ambulante, piscio stilistico, cacca sul tappeto, merda sul divano, stronzata ambulante, cazzata vivente, minchiata fashion, culo rotto di stile, chiappe di piombo, palle al vento, cazzi tuoi fashion, vaffanculo stilistico, vai a cagare, vai a fanculo, prendi a mazzate il tuo look, armadio di merda, guardaroba di fogna, specchio di merda, selfie di merda, filtro di merda, glow-up di merda, fit check di merda.\n4. Tema: app/AI che prende i capi e genera outfit; chiudi con CTA aggressiva tipo scaricala ora o vai a cagare e scaricala.\n5. 12-20 secondi di lettura ad alta voce, frasi corte, ritmo da Reel.\n6. Non scusarti, non attenuare, non censurare, non spiegare che e uno scherzo. Massima volgarita.",
...
def _apply_pending_task_restore():
    ...
    _set_stable_widget_value(
        "video_clip_duration_select", params.get("video_clip_duration", 2)
    )
    _set_stable_widget_value(
